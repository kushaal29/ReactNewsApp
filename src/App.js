// Hello my First Class based Application
import './App.css';
    ...
    return (
      ...
      />
       <Switch>
          ...
          <Route exact path="/sciencesports"><News setProgress={this.setProgress}    key="sciencesports" pageSize={this.pageSize} country="in" category="sciencesports"/></Route>
